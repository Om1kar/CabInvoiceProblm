...
public class CabInvoiceGeneratorTest {
    ...
    public void givenMultipleRidesWhenPremiumShouldReturnTotalFare(){
        Ride[] ride1 = { new Ride(20,6, Ride.RideType.PREMIUM), new Ride(10, 5, Ride.RideType.PREMIUM),
                new Ride(0.3, 1, Ride.RideType.PREMIUM),new Ride(5, 2, Ride.RideType.PREMIUM)};

        Ride[] ride2 = { new Ride(10,4, Ride.RideType.PREMIUM), new Ride(20, 3, Ride.RideType.PREMIUM),
                new Ride(0.2, 2, Ride.RideType.PREMIUM),new Ride(10, 5, Ride.RideType.PREMIUM)};
